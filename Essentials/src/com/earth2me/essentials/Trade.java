...
import com.earth2me.essentials.api.EssentialsPayUserEvent;
...
public class Trade {
	...
	private final transient ISign sign;
    ...
    public Trade(final String command, final IEssentials ess) {
        this(command, null, null, null, null, ess, null);
    }

    public Trade(final String command, final IEssentials ess, final ISign sign) {
        this(command, null, null, null, null, ess, sign);
    }

    public Trade(final String command, final Trade fallback, final IEssentials ess) {
        this(command, fallback, null, null, null, ess, null);
    }

    public Trade(final String command, final Trade fallback, final IEssentials ess, final ISign sign) {
        this(command, fallback, null, null, null, ess, sign);
    }

    @Deprecated
    public Trade(final double money, final com.earth2me.essentials.IEssentials ess) {
        this(null, null, BigDecimal.valueOf(money), null, null, (IEssentials) ess, null);
    }

    @Deprecated
    public Trade(final double money, final com.earth2me.essentials.IEssentials ess, final ISign sign) {
        this(null, null, BigDecimal.valueOf(money), null, null, (IEssentials) ess, sign);
    }

    public Trade(final BigDecimal money, final IEssentials ess) {
        this(null, null, money, null, null, ess, null);
    }

    public Trade(final BigDecimal money, final IEssentials ess, final ISign sign) {
        this(null, null, money, null, null, ess, sign);
    }

    public Trade(final ItemStack items, final IEssentials ess) {
        this(null, null, null, items, null, ess, null);
    }

    public Trade(final ItemStack items, final IEssentials ess, final ISign sign) {
        this(null, null, null, items, null, ess, sign);
    }

    public Trade(final int exp, final IEssentials ess) {
        this(null, null, null, null, exp, ess, null);
    }

    private Trade(final String command, final Trade fallback, final BigDecimal money, final ItemStack item, final Integer exp, final IEssentials ess, final ISign sign) {
